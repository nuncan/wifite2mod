...
class Configuration(object):
    ...
    def initialize(cls, load_interface=True):
        ...
        cls.show_manufacturers = True  # Show manufacturers in targets list
        ...
        cls.wpa_attack_timeout = 250  # Wait time before failing
        ...
        cls.cracked_file = '../wordlist-top4800-probable.txt'
        cls.wordlist = None
        wordlists = [
        ...
        cls.wps_timeout_threshold = 25  # Max number of timeouts
    ...
    def parse_wpa_args(cls, args):
        ...
        if args.wordlist:
            if not os.path.exists(args.wordlist):
                ...
                cls.wordlist = None
                Color.pl(
                    '{+} {C}option:{O} wordlist {R}%s{O} is a directory, not a file. Wifite will NOT attempt to crack handshakes' % args.wordlist)
